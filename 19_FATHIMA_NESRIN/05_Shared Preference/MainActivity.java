...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        username=(EditText)findViewById(R.id.idEdtUserName);
        mobilenum=(EditText)findViewById(R.id.idEdtmobile);
        email=(EditText)findViewById(R.id.idEmail);
        pass1=(EditText)findViewById(R.id.idEdtPassword);
        pass2=(EditText)findViewById(R.id.idPassword);
